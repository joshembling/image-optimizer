...
class ImageOptimizerServiceProvider extends PackageServiceProvider
{
    ...
    public static string $viewNamespace = 'filament-image-optimizer';
    ...
    {
        return 'joshembling/filament-image-optimizer';
    }
    ...
    {
        return [
            // AlpineComponent::make('filament-image-optimizer', __DIR__ . '/../resources/dist/components/filament-image-optimizer.js'),
            Css::make('filament-image-optimizer-styles', __DIR__ . '/../resources/dist/filament-image-optimizer.css'),
            Js::make('filament-image-optimizer-scripts', __DIR__ . '/../resources/dist/filament-image-optimizer.js'),
        ];
    }
    ...
    {
        return [
            'create_filament-image-optimizer_table',
        ];
    }
}
